        ...
        try {
            ...
            if (result.text) {
                setPlayerInputs((prev) => {
                    ...
                    newInputs[activeUser] = result.text;
                    return newInputs;
                });
            }
                            ...
                            >
                                {isNarrator && isLastMessage ? (
                                    <>
                                        ...
                                        <Button size="sm" onClick={() => toggleAudio(index, msg.text)} className="ms-2">
                                            {loadingAudioIndex === index ? <Spinner size="sm" /> : playingIndex === index ? <FaPause /> : <FaPlay />}
                                        </Button>
                                    </>
